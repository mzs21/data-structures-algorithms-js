const ascending_Insertion_Sort = (arr) => 
{
    let item;
...
const descending_Insertion_Sort = (arr) => 
{
...
console.log("Sorted Array (Ascending): " + ascending_Insertion_Sort(newArray));

console.log("Sorted Array (Descending): " + descending_Insertion_Sort(newArray));
