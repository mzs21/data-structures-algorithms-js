    ...
    */
    ...
    BFS(startVertex)
    {
        ...
        while(queue.length)                       // while stack is not empty
        {
            ...
            this.adjacencyList[currentVertex].slice().reverse().forEach(neighbor =>       // Will loop through all the vertices
                {
                    if(!visited[neighbor])                              // If the vertex is not visited
                    {
                        visited[neighbor] = true;                       // make it visited
...
// To change the order of BFS do 'this.adjacencyList[currentVertex].slice().reverse().forEach' on line 134
